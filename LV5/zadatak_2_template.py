...
classes,train_counter=np.unique(y_train,return_counts=True)
classes,test_counter=np.unique(y_test,return_counts=True)
x_axis=np.arange(len(classes))


plt.bar(x_axis+0.2,train_counter,0.2)
plt.bar(x_axis-0.2,test_counter,0.2)
